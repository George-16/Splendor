...
import time
import numpy as np
# python3 splendor_runner.py -r agents.GreatSplendor.Q_Contest -c agents.GreatSplendor.Q_Contest1 -p
# python3 splendor_runner.py -r agents.GreatSplendor.Q_Contest1 -c agents.GreatSplendor.Q_Contest -p
...
class myAgent(Agent):
    ...
    def Collect_Features(self, action, gems, resources, reserves, dealt_cards, opp_gems,
        ...
        # feature 1,2,3,4 : distances with increasing ratio
